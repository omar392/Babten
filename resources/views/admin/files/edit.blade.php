            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="" id="files" method="POST" data-parsley-validate>
                                @csrf
                                @method('put')
                                <input type="hidden" name="fileId" id="file_id" value="{{$file->id}}" class="form-control">
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">{{ __('admin.name_ar') }}</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $file->name_ar }}" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $file->name_en }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" name="file" id="file" value="{{$file->file}}"  class="filestyle image" data-buttonname="btn-primary" >
                                    </div>
                                </div>
...
<script>
    $(function () {
            ...
            $('body').on('submit','#files',function (e) {
                e.preventDefault();
                //  alert('no problem');
                 let id = $('#file_id').val();
                 var url = '{{ route('files.update', ':id') }}';
