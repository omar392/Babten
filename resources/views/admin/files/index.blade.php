    ...
    <div class="content">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title">{{ __('admin.files') }}</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        <li class="breadcrumb-item"><a href="{{ route('adminhome') }}">{{ __('admin.home') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('admin.files') }}</li>
                    </ol>
                </div>
            </div> <!-- end row -->
            <br>
            <div class="row align-items-center">
                ...
                <div class="text-center">
                    <!-- Large modal -->
                    @if (Auth::guard('admin')->user()->hasPermission('files-create'))
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                            data-target="#modal-add-file" style="margin-right: 20px;margin-left: 20px;"><i
                ...
                <div class="modal fade modal-add-file" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                    aria-hidden="true" id="modal-add-file">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="modal-add-file">
                                <div class="modal-body">
                                    <div class="card-body">
                                        <form id="addfile" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                            @csrf
                                            @method('post')
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input"
                                                    class="col-sm-2 col-form-label">{{ __('admin.file') }}</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control .inp3" type="file" name="file" id="file">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status == 'success') {
                            ...
                            $("#addfile").trigger("reset");
                            $('#modal-add-file .close').click();
