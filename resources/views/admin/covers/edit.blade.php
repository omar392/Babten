                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="" id="covers" method="POST" data-parsley-validate>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">{{ __('admin.image_jobs') }}</label>
                                    <div class="col-sm-10">
                                        <input type="file" name="image_jobs" id="image_jobs" value="{{$cover->image_jobs}}"  class="filestyle image_jobs" data-buttonname="btn-primary" >
                                        <img src="{{ asset('dashboard/' . $cover->image_jobs) }}"
                                        width="340" height="200" alt=""
                                        style="margin-right: 70px;border-radius: 15px;"
                                        class="image_jobs"/>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">{{ __('admin.image_jobs_2') }}</label>
                                    <div class="col-sm-10">
                                        <input type="file" name="image_jobs_2" id="image_jobs_2" value="{{$cover->image_jobs_2}}"  class="filestyle image_jobs_2" data-buttonname="btn-primary" >
                                        <img src="{{ asset('dashboard/' . $cover->image_jobs_2) }}"
                                        width="340" height="200" alt=""
                                        style="margin-right: 70px;border-radius: 15px;"
                                        class="image_jobs_2"/>
                                    </div>
...
<script>
    ...
    $(".image_jobs").change(function() {

        if (this.files && this.files[0]) {
            var reader = new FileReader();

            reader.onload = function(e) {
                $('.image_jobs').attr('src', e.target.result);
            }

            reader.readAsDataURL(this.files[0]);
        }
    });
    $(".image_jobs_2").change(function() {

        if (this.files && this.files[0]) {
            var reader = new FileReader();

            reader.onload = function(e) {
                $('.image_jobs_2').attr('src', e.target.result);
            }
