                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="modal-add-location">
                                <div class="modal-body">
                                    <div class="card-body">
                                        <form id="addlocation" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input id="alert" class="form-control .inp1" value="{{ old('lat') }}"
                                                        type="text" name="lat" id="example-text-input"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control .inp5" value="{{ old('lang') }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control .inp2" value="{{ old('url') }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control .inp3" name="description_ar" id="editor1" cols="10" rows="10"></textarea>
                                                    <script>
                                            ...
                                            <div class="form-group text-center m-t-20">
                                                <div class="col-12">
                                                    <button onclick="" class="btn btn-primary btn-block btn-lg"
                                                        name="submit" type="submit">{{ __('admin.add') }}</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
@push('js')
    ...
    <script>
        $('body').on('submit', '#addlocation', function(e) {
            e.preventDefault();
            if ($('.inp1').is(':empty') || $('.inp2').is(':empty') || $('.inp3').is(':empty') || $('.inp4').is(':empty') || $('.inp5').is(':empty')) {} else {
                $.ajax({
