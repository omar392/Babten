                        ...
                        <div class="card-body">
                            <form action="" id="locations" method="POST" data-parsley-validate>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $location->lat }}" type="text"
                                            name="lat" id="example-text-input"
                                            placeholder="{{ __('admin.lat') }} " parsley-trigger="change" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $location->lang }}"
                                            name="lang" id="example-text-input"
                                            placeholder="{{ __('admin.lang') }}"  parsley-trigger="change" >
                                            <span class="text-danger" id="langError"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $location->url }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="description_ar" id="editor3" cols="10" rows="10">{!! $location->description_ar !!}</textarea>
                                     <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="description_en" id="editor4" cols="10" rows="10">{!! $location->description_en !!}</textarea>
                                     <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" name="image" id="image" value="{{$location->image}}"  class="filestyle image" data-buttonname="btn-primary" >
                                        <img src="{{ asset('/dashboard/locations/' . $location->image) }}"
            ...
            $('body').on('submit','#locations',function (e) {
                ...
                $.ajax({
                    ...
                    error:function (response) {
                        $('#latError').text(response.responseJSON.errors.lat);
                        $('#langError').text(response.responseJSON.errors.lang);
