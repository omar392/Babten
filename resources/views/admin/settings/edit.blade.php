                            ...
                            <div class="card-body">
                                <form action="" id="settings" method="POST" data-parsley-validate>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->mobile }}" name="mobile"
                                                id="example-text-input" placeholder="Mobile" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Whats app</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->whatsapp }}" name="whatsapp"
                                                id="example-text-input" placeholder="{{ __('admin.whatsapp') }}" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->footer_en }}"
                                                name="footer_en" id="example-text-input"
                                                placeholder="{{ __('admin.footer_en') }}" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->brandtitle_ar }}"
                                                type="text" name="brandtitle_ar" id="example-text-input"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->brandtitle_en }}"
                                                type="text" name="brandtitle_en" id="example-text-input"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->welcometext_ar }}"
                                                type="text" name="welcometext_ar" id="example-text-input"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->welcometext_en }}"
                                                type="text" name="welcometext_en" id="example-text-input"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->msgtext_ar }}"
                                                type="text" name="msgtext_ar" id="example-text-input"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->msgtext_en }}"
                                                type="text" name="msgtext_en" id="example-text-input"
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">mail_host</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->mail_host }}"
                                                name="mail_host" id="example-text-input" placeholder="mail_host" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">mail_port</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->mail_port }}"
                                                name="mail_port" id="example-text-input" placeholder="mail_port" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->mail_username }}"
                                                name="mail_username" id="example-text-input" placeholder="mail_username"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="password"
                                                value="{{ $setting->mail_password }}" name="mail_password"
                                                id="example-text-input" placeholder="mail_password" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">mail_from</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->mail_from }}"
                                                name="mail_from" id="example-text-input" placeholder="mail_from" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Contact
                                            mail</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->contact_mail }}"
                                                name="contact_mail" id="example-text-input" placeholder="contact_mail"
                                                required parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Offer
                                            mail</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->offer_mail }}"
                                                name="offer_mail" id="example-text-input" placeholder="offer_mail"
                                                required parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
