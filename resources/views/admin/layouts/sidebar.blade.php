                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('services.index') }}" class="waves-effect">
                                <i class="fas fa-praying-hands"></i><span class="badge badge-success badge-pill float-right"></span> <span> {{ __('admin.services') }} </span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{ route('employments.index') }}" class="waves-effect">
                                <i class="fas fa-user-tie"></i><span class="badge badge-success badge-pill float-right"></span> <span> {{ __('admin.employments') }} </span>
                            </a>
                        </li>
                        @endif
                        ...
                        @endif
                        @if(Auth::guard('admin')->user()->hasPermission('files-read'))
                        <li>
                            <a href="{{ route('files.index') }}" class="waves-effect">
                                <i class="far fa-file-pdf"></i><span class="badge badge-success badge-pill float-right"></span> <span> {{ __('admin.files') }} </span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('counters.index')}}" class="waves-effect">
                                <i class="fas fa-sort-amount-down"></i><span>{{ __('admin.counters') }}</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('locations.index')}}" class="waves-effect">
                                <i class="fas fa-location-arrow"></i></i><span>{{ __('admin.locations') }}</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('insurances.index')}}" class="waves-effect">
                                <i class="fas fa-compress-arrows-alt"></i><span>{{ __('admin.insurances') }}</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('covers.index')}}" class="waves-effect">
                                <i class="far fa-image"></i><span>{{ __('admin.covers') }}</span>
                            </a>
                        </li>
                        @endif
                    </ul>
