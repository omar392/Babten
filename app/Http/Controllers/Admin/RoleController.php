...
class RoleController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $models = ['admins','roles','users','countries','banners','locations', 'employments','files','galleries','services','partners','insurances','faqs','settings','seos','counters','abouts','covers'];
